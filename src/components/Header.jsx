        ...
        <div className="flex items-center justify-between px-4 py-4 md:px-12">
          ...
          <div className="flex items-center space-x-15">
            ...
            <nav className="hidden lg:flex items-center space-x-8">
              <a href="#Explore" className="text-gray-300 hover:text-gray-400 transition-colors font-medium text-lg">Explorar</a>
              <a href="#Ranking" className="text-gray-300 hover:text-gray-400 transition-colors text-lg">Clasificaciones</a>
              {/* Dropdown Categories */}
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative group">
              ...
              <div className="absolute right-0 top-full mt-2 w-48 bg-black/95 border border-gray-700 rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                <div className="p-2">
                  <a href="/profile" className="block px-3 py-2 text-white hover:bg-gray-800 rounded text-sm">Cuenta</a>
                  <hr className="border-gray-700 my-2" />
                  <a
                    href="#"
                    className="block px-3 py-2 text-white hover:bg-gray-800 rounded text-sm"
                    onClick={() => {
                      logout();
                      navigate("/login");
                    }}
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden bg-black/95 border-t border-gray-700">
            <nav className="flex flex-col p-4 space-y-4">
              ...
              >
                <span className="text-gray-300 hover:text-gray-400">Categorías</span>
              </button>
              {/* Submenu Categories */}
              {isCategoriesOpen && (
